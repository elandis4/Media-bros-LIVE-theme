  ...
  function faqAutocomplete() {
    $(".js-faq-autocomplete").autocomplete({
        lookup: function(query, done) {
            var results = $.map(faq_items, function(suggestion) {
                if (
                    suggestion.content.toLowerCase().indexOf(query.toLowerCase()) > -1 ||
            ...
            // Limit results to a maximum of 8
              if (window.matchMedia("(min-width: 697px)").matches) {
				results = results.slice(0, 8);
			  } else if (window.matchMedia("(max-width: 582px)").matches) {
			    results = results.slice(0, 5);
			  } else if (window.matchMedia("(max-width: 696px) and (min-width: 583px").matches) {
...
var blackMask = $('.quiz-outer-ctr__black-mask');
function fadeInAnim() {
	blackMask.css('visibility', 'visible');
	$('.quiz-outer-container').first().addClass('fade-in-anim');
}

function quizCompleteOrNot(){
	if (localStorage.recommendedProduct){
		fadeInResults();
		$('.'+localStorage.recommendedProduct).removeClass('hide');
		if (localStorage.recommendedProduct2){
			$('.'+localStorage.recommendedProduct2).removeClass('hide');
		}
		if (localStorage.recommendedProduct3){
			$('.'+localStorage.recommendedProduct3).removeClass('hide');
		}
		if (localStorage.recommendedProduct4){
			$('.'+localStorage.recommendedProduct4).removeClass('hide');
		}
	}else{
		introPageRefresh();
	}
...
// var quizDiscountCode = `{{ section.settings.discount_code }}`
function autoAddDiscount() {
	// Save the discount code as a session cookie
	document.cookie = `discount_code=${quizDiscountCode}; path=/`;

	// Send GET request to "/discount/[discountcode]"
	$.get(`/discount/${quizDiscountCode}`)
		.done(function() {
...
function introPageRefresh(){
	$('.intro-page').removeClass('hide');
	$('.quiz-container__inner-ctr').css('display', 'block');
}
function startQuiz(){
	transitionToNext('.intro-page', '.question-one');
}
	function introPageBackBtn(){
		transitionToNext('.question-one', '.intro-page');
	}
function hydrocarbonSelection(){
	transitionToNext('.question-one', '.question-three-halves');
}
function CO2Selection(){
	transitionToNext('.question-one', '.question-two-alt');
}
function yesPesticideSelection(){
	transitionToNext('.question-three-halves', '.question-two-alt2');
	// $('.question-three-halves').addClass('hide');
	// $('.question-two-alt2').removeClass('hide');
}
	function pesticideBackBtn(){
		transitionToNext('.question-two', '.question-three-halves');
		// $('.question-two-alt2').addClass('hide');
		// $('.question-two').addClass('hide');
		// $('.question-three-halves').removeClass('hide');
	}
	function pesticideBackBtn2(){
		transitionToNext('.question-two-alt2', '.question-three-halves');
	}
function heavyPesticideSelection(){
	transitionToNext('.question-two-alt2', '.question-three-new7');
	// $('.question-two-alt2').addClass('hide');
	// $('.question-three-new7').removeClass('hide');
}
function lowPesticideSelection(){
	transitionToNext('.question-two-alt2', '.question-three-new8');
	// $('.question-two-alt2').addClass('hide');
	// $('.question-three-new8').removeClass('hide');
}
function noPesticideSelection(){
	transitionToNext('.question-three-halves', '.question-two');
	// $('.question-three-halves').addClass('hide');
	// $('.question-two').removeClass('hide');
}
function inlineSelection(){
	// transitionToNext('.question-two-alt');
	// $('.question-two-alt').fadeOut(200).addClass('hide');
	showRecommendedProduct('.question-two-alt');
	$('.CR2').removeClass('hide');
	localStorage.recommendedProduct = 'CR2';
	autoAddDiscount();
}
function postProcessSelection(){
	transitionToNext('.question-two-alt', '.question-three-new3');
	// $('.question-two-alt').addClass('hide');
	// $('.question-three-new3').removeClass('hide');
}
function ethanolSelection(){
	transitionToNext('.question-one', '.question-two2');
	// $('.question-one').addClass('hide');
	// $('.question-two2').removeClass('hide');
}
	function solventBackBtn(){
		transitionToNext('.question-three-halves', '.question-one');
		// $('.question-three-halves').addClass('hide');
		// $('.question-one').removeClass('hide');
	}
	function solventBackBtn2(){
		transitionToNext('.question-two2', '.question-one');
		// $('.question-two2').addClass('hide');
		// $('.question-two-alt').addClass('hide');
		// $('.question-one').removeClass('hide');
	}
	function solventBackBtn3(){
		transitionToNext('.question-two-alt', '.question-one');
		// $('.question-two2').addClass('hide');
		// $('.question-two-alt').addClass('hide');
		// $('.question-one').removeClass('hide');
	}
function heavyColorSelection(){
	transitionToNext('.question-two', '.question-three-new6');
	// $('.question-two').addClass('hide');
	// $('.question-three-new6').removeClass('hide');
}
function moderateColorSelection(){
	transitionToNext('.question-two', '.question-three-new5');
	// $('.question-two').addClass('hide');
	// $('.question-three-new5').removeClass('hide');
}
function lightColorSelection(){
	transitionToNext('.question-two', '.question-three-new4');
	// $('.question-two').addClass('hide');
	// $('.question-three-new4').removeClass('hide');
}
function heavyColorSelection2(){
	transitionToNext('.question-two2', '.question-three-new2');
	// $('.question-two2').addClass('hide');
	// $('.question-three-new2').removeClass('hide');
}
function lightColorSelection2(){
	transitionToNext('.question-two2', '.question-three-new');
	// $('.question-two2').addClass('hide');
	// $('.question-three-new').removeClass('hide');
}
	function colorBackBtn(){
		transitionToNext('.question-three-new', '.question-two2');
		// transitionToNext('.question-three-new2', '.question-two2');
		// $('.question-three-new').addClass('hide');
		// $('.question-three-new2').addClass('hide');
		// $('.question-two2').removeClass('hide');
	}
	function colorBackBtn1a(){
		// transitionToNext('.question-three-new', '.question-two2');
		transitionToNext('.question-three-new2', '.question-two2');
	}
	function colorBackBtn2(){
		transitionToNext('.question-three-new4', '.question-two');
		// transitionToNext('.question-three-new5', '.question-two');
		// transitionToNext('.question-three-new6', '.question-two');
		// $('.question-three-new4').addClass('hide');
		// $('.question-three-new5').addClass('hide');
		// $('.question-three-new6').addClass('hide');
		// $('.question-two').removeClass('hide');
	}
	function colorBackBtn2a(){
		// transitionToNext('.question-three-new4', '.question-two');
		transitionToNext('.question-three-new5', '.question-two');
		// transitionToNext('.question-three-new6', '.question-two');
	}
	function colorBackBtn2b(){
		// transitionToNext('.question-three-new4', '.question-two');
		// transitionToNext('.question-three-new5', '.question-two');
		transitionToNext('.question-three-new6', '.question-two');
	}
	function colorBackBtn3(){
		transitionToNext('.question-three-new3', '.question-two-alt');
		// $('.question-three-new3').addClass('hide');
		// $('.question-two-alt').removeClass('hide');
	}
	function pestLevelBackBtn(){
		transitionToNext('.question-three-new7', '.question-two-alt2');
		// transitionToNext('.question-three-new8', '.question-two-alt2');
		// $('.question-three-new7').addClass('hide');
		// $('.question-three-new8').addClass('hide');
		// $('.question-two-alt2').removeClass('hide');
	}
	function pestLevelBackBtn2(){
		// transitionToNext('.question-three-new7', '.question-two-alt2');
		transitionToNext('.question-three-new8', '.question-two-alt2');
	}
function granularSelection(){
	// transitionToNext('.question-one');
	$('.question-three-new').addClass('hide');
	showRecommendedProduct();
	$('.Activated-Alumina').removeClass('hide');
	$('.PR-O').removeClass('hide');
	localStorage.recommendedProduct = 'Activated-Alumina';
	localStorage.recommendedProduct2 = 'PR-O';
	autoAddDiscount();
}
function powderedSelection(){
	// transitionToNext('.question-one');
	$('.question-three-new').addClass('hide');
	showRecommendedProduct();
	$('.PR-W').removeClass('hide');
	$('.Perform-5000').removeClass('hide');
	$('.Perform-6000').removeClass('hide');
	localStorage.recommendedProduct = 'PR-W';
	localStorage.recommendedProduct2 = 'Perform-5000';
	localStorage.recommendedProduct3 = 'Perform-6000';
	autoAddDiscount();
}
function granularSelection2(){
	// transitionToNext('.question-one');
	$('.question-three-new2').addClass('hide');
	showRecommendedProduct();
	$('.G-CRAC').removeClass('hide');
	$('.PR-O').removeClass('hide');
	localStorage.recommendedProduct = 'G-CRAC';
	localStorage.recommendedProduct2 = 'PR-O';
	autoAddDiscount();
}
function powderedSelection2(){
	// transitionToNext('.question-one');
	$('.question-three-new2').addClass('hide');
	showRecommendedProduct();
	$('.PR-W').removeClass('hide');
	$('.CRAC').removeClass('hide');
	localStorage.recommendedProduct = 'PR-W';
	localStorage.recommendedProduct2 = 'CRAC';
	autoAddDiscount();
}
function granularSelection3(){
	// transitionToNext('.question-one');
	$('.question-three-new3').addClass('hide');
	showRecommendedProduct();
	$('.G-CRAC').removeClass('hide');
...
function powderedSelection3(){
	...
	localStorage.recommendedProduct = 'PR-W';
	localStorage.recommendedProduct2 = 'CRAC';
	localStorage.recommendedProduct3 = 'Perform-5000';
	localStorage.recommendedProduct4 = 'Perform-6000';
	autoAddDiscount();
}
function granularSelection4(){
	// transitionToNext('.question-one');
	$('.question-three-new4').addClass('hide');
	showRecommendedProduct();
	$('.CRX').removeClass('hide');
	$('.CRX-M').removeClass('hide');
	$('.Activated-Alumina').removeClass('hide');
	localStorage.recommendedProduct = 'CRX';
	localStorage.recommendedProduct2 = 'CRX-M';
	localStorage.recommendedProduct3 = 'Activated-Alumina';
	autoAddDiscount();
}
function powderedSelection4(){
	// transitionToNext('.question-one');
	$('.question-three-new4').addClass('hide');
	showRecommendedProduct();
	$('.B80').removeClass('hide');
	localStorage.recommendedProduct = 'B80';
	autoAddDiscount();
}
function granularSelection5(){
	// transitionToNext('.question-one');
	$('.question-three-new5').addClass('hide');
	showRecommendedProduct();
	$('.CRY').removeClass('hide');
	$('.CRY-M').removeClass('hide');
	localStorage.recommendedProduct = 'CRY';
	localStorage.recommendedProduct2 = 'CRY-M';
	autoAddDiscount();
}
function powderedSelection5(){
	// transitionToNext('.question-one');
	$('.question-three-new5').addClass('hide');
	showRecommendedProduct();
	$('.Perform-5000').removeClass('hide');
	$('.Perform-6000').removeClass('hide');
	localStorage.recommendedProduct = 'Perform-5000';
	localStorage.recommendedProduct2 = 'Perform-6000';
	autoAddDiscount();
}
function granularSelection6(){
	// transitionToNext('.question-one');
	$('.question-three-new6').addClass('hide');
	showRecommendedProduct();
	$('.CR41').removeClass('hide');
	$('.G-CRAC').removeClass('hide');
	$('.PR-O').removeClass('hide');
	localStorage.recommendedProduct = 'CR41';
	localStorage.recommendedProduct2 = 'G-CRAC';
	localStorage.recommendedProduct3 = 'PR-O';
	autoAddDiscount();
}
function powderedSelection6(){
	// transitionToNext('.question-one');
	$('.question-three-new6').addClass('hide');
	showRecommendedProduct();
	$('.SILICA-GEL').removeClass('hide');
	$('.PR-W').removeClass('hide');
	$('.CRAC').removeClass('hide');
	localStorage.recommendedProduct = 'SILICA-GEL';
	localStorage.recommendedProduct2 = 'PR-W';
	localStorage.recommendedProduct3 = 'CRAC';
	autoAddDiscount();
}
function granularSelection7(){
	// transitionToNext('.question-one');
	$('.question-three-new7').addClass('hide');
	showRecommendedProduct();
	$('.G-CRAC').removeClass('hide');
...
function powderedSelection7(){
	// transitionToNext('.question-one');
	$('.question-three-new7').addClass('hide');
	showRecommendedProduct();
	$('.CRAC').removeClass('hide');
	$('.PR-W').removeClass('hide');
	localStorage.recommendedProduct = 'CRAC';
	localStorage.recommendedProduct2 = 'PR-W';
	autoAddDiscount();
}
function granularSelection8(){
	// transitionToNext('.question-one');
	$('.question-three-new8').addClass('hide');
	showRecommendedProduct();
	$('.PR-O').removeClass('hide');
	$('.CR41').removeClass('hide');
	localStorage.recommendedProduct = 'PR-O';
	localStorage.recommendedProduct2 = 'CR41';
	autoAddDiscount();
}
function powderedSelection8(){
	// transitionToNext('.question-one');
	$('.question-three-new8').addClass('hide');
	showRecommendedProduct();
	$('.PR-W').removeClass('hide');
...
function showRecommendedProduct(fadeOutQuestion){
	const fadeQuestion = $(fadeOutQuestion);
	$('.quiz-container__inner-ctr').fadeOut(200);
	fadeQuestion.fadeOut(200);
	$('.quiz-container').fadeOut(200);
	$('.quiz-outer-container').fadeOut(200);
	$('.quiz-outer-ctr__black-mask').fadeOut(200);
	setTimeout(function(){
		fadeInResults();
		fadeQuestion.addClass('hide');
	}, 200)
}
function fadeInResults() {
	$('.quiz-container__inner-ctr').css('display', 'none');
	$('.quiz-outer-ctr__black-mask').fadeIn(1);
	$('.quiz-outer-ctr__black-mask').css('backgroundColor', 'white');
	$('.recommended-product').removeClass('hide').hide().fadeIn(300);
	$('.quiz-container').removeClass('bg-image').hide().fadeIn(300);
	$('.quiz-outer-container').removeClass('bg-image2').hide().fadeIn(300);
}
function transitionToNext(currentSelector, ...nextSelectors) {
    const currentElement = $(currentSelector);
    currentElement.addClass('fade-out');

    setTimeout(() => {
        currentElement.addClass('hide').removeClass('fade-out');

        nextSelectors.forEach(selector => {
            const nextElement = $(selector);
            nextElement.removeClass('hide').hide().fadeIn(300); // Fade in with duration 500ms
        });
    }, 200); // Match this timeout to the CSS transition duration
}

function retakeQuiz(){
	localStorage.recommendedProduct = '';
	localStorage.recommendedProduct2 = '';
	localStorage.recommendedProduct3 = '';
	localStorage.recommendedProduct4 = '';
	$('.recommended-product').addClass('hide');
	introPageRefresh();
	$('.quiz-container').addClass('bg-image');
	$('.quiz-outer-container').addClass('bg-image2');
	$('.quiz-product-card').addClass('hide');
	// document.cookie = `discount_code=CLEARQUIZDISCOUNT; path=/`;
	// $.get(`/discount/CLEARQUIZDISCOUNT`)
	// 	.done(function() {
	// 		$.ajax({
	// 			url: '/cart/update.js',
	// 			method: 'POST',
...
var tablePopUpCtr = $('.suggested-use__full-size-table-ctr');
var tableCloseBtn = $('.table__close-btn');
var tableViewBtn = $('.sqs-block-image-button');
...
$(window).click(function(event) {
	if ($(event.target).is(tablePopUpCtr)) {
		tablePopUpCtr.hide();
	}
});